...
struct Gen1Layout {
    ...
    static constexpr std::size_t MissableObjectsLen = 29;
    static constexpr int MissableObjectsUsedBits = 228;
    static constexpr std::size_t CurrentScriptsOff = 0x289C;
    static constexpr std::size_t CurrentScriptsLen = 0x0100;
    ...
    static constexpr std::size_t SafariStepsOff = 0x29B9;
    static constexpr std::size_t WorldFlags1Off = 0x29D4;
    static constexpr std::size_t BadgesMirror2Off = 0x29D6;
    ...
    static constexpr int EventFlagsUsedBits = EventFlagsLen * 8;
    ...
    static constexpr std::size_t BoxSpeciesRel = 0x0001;
    static constexpr std::size_t BoxSpeciesTerminatorRel = 0x0015;
    static constexpr std::size_t BoxPaddingRel = 0x0015;
    static constexpr std::size_t BoxStructsRel = 0x0016;
    static constexpr std::size_t BoxStructSize = 0x0021;
    static constexpr std::size_t BoxOTNamesRel = 0x02AA;
    static constexpr std::size_t BoxNicknamesRel = 0x0386;
    static constexpr std::size_t BoxMonSpeciesRel = 0x00;
    static constexpr std::size_t BoxMonCurrentHpRel = 0x01;
    static constexpr std::size_t BoxMonLevelRel = 0x03;
    static constexpr std::size_t BoxMonStatusRel = 0x04;
    static constexpr std::size_t BoxMonType1Rel = 0x05;
    static constexpr std::size_t BoxMonType2Rel = 0x06;
    static constexpr std::size_t BoxMonCatchRateRel = 0x07;
    static constexpr std::size_t BoxMonMovesRel = 0x08;
    static constexpr std::size_t BoxMonTrainerIdRel = 0x0C;
    static constexpr std::size_t BoxMonExperienceRel = 0x0E;
    static constexpr std::size_t BoxMonHpStatExpRel = 0x11;
    static constexpr std::size_t BoxMonAttackStatExpRel = 0x13;
    static constexpr std::size_t BoxMonDefenseStatExpRel = 0x15;
    static constexpr std::size_t BoxMonSpeedStatExpRel = 0x17;
    static constexpr std::size_t BoxMonSpecialStatExpRel = 0x19;
    static constexpr std::size_t BoxMonDvWordRel = 0x1B;
    static constexpr std::size_t BoxMonPpRel = 0x1D;
    ...
    static constexpr std::size_t Bank2BoxChecksumsOff = 0x5A4D;
    ...
    static constexpr std::size_t Bank3BoxChecksumsOff = 0x7A4D;
